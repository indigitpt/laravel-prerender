<?php return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Throw Exceptions on Debug
    |--------------------------------------------------------------------------
    |
    | When the app is on the debug, if we should throw exception on 404, and other
    | falsy codes.
    |
    */

    'debug' => env('PRERENDER_THROW_ON_DEBUG_ENABLE', false),
   ...
   |--------------------------------------------------------------------------
   |
   | Set to TRUE, if you want to always use pre-render for all pages.
   | Use with care only for debug proposes
   |
   */

    'always_render' => env('PRERENDER_ALWAYS_ENABLE', false),
    ...
    */
    ...
    /*
   |--------------------------------------------------------------------------
   | Prerender Username / Password Auth
   |--------------------------------------------------------------------------
   |
   | If you using the HTTP Basic auth plugin, you can define the username and
   | password right here.
   |
   */

    'username' => env('PRERENDER_USERNAME',false),
    'password' => env('PRERENDER_PASSWORD',false),
